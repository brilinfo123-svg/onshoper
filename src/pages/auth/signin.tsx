...
const RegistrationForm: React.FC = () => {
  // Generate a random userId using a random number
  ...
  const [formData, setFormData] = useState({
    ...
    confirmPassword: "",
    otp: "", // OTP field
    userId: generateUniqueUserId(), // Generate unique userId using random number
  });
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validateForm()) {
      sendOtp(); // Only send OTP after validating the form
      ...
      <div className={styles.formWrapper}>
        ...
        {!isSignUpSubmitted ? (
          <form onSubmit={handleSubmit}>
            {/* User ID */}
            <div className={`${styles.formGroup} ${styles.unicHide}`}>
              <label>
                <span className="icon-mail"></span>User ID
              </label>
              <input
                type="text"
                id="userId"
